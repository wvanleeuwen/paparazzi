...
const clock_scale_t hse_26mhz_3v3 = { /* 168MHz */
         .pllm = 26,
         .plln = 336,
         .pllp = 2,
         .pllq = 7,
...
#endif
#elif EXT_CLK == 26000000
#if defined(STM32F4)
  PRINT_CONFIG_MSG("Using 26MHz external clock to PLL it to 168MHz.")
  rcc_clock_setup_hse_3v3(&hse_26mhz_3v3);
#endif
#else
