...
#define USE_PWM_DOUBLE3 1
#define USE_PWM_DOUBLE4 1

#if USE_PWM_DOUBLE3
#define PWM_DOUBLE_SERVO_3 0
#define PWM_DOUBLE_SERVO_3_TIMER TIM4
#define PWM_DOUBLE_SERVO_3_RCC_IOP RCC_APB2ENR_IOPBEN
#define PWM_DOUBLE_SERVO_3_GPIO GPIOB
#define PWM_DOUBLE_SERVO_3_PIN GPIO8
#define PWM_DOUBLE_SERVO_3_AF 0
#define PWM_DOUBLE_SERVO_3_OC TIM_OC3
#define PWM_DOUBLE_SERVO_3_OC_BIT (1<<2)
#else
#define PWM_DOUBLE_SERVO_3_OC_BIT 0
#endif

#if USE_PWM_DOUBLE4
#define PWM_DOUBLE_SERVO_4 1
#define PWM_DOUBLE_SERVO_4_TIMER TIM4
#define PWM_DOUBLE_SERVO_4_RCC_IOP RCC_APB2ENR_IOPBEN
#define PWM_DOUBLE_SERVO_4_GPIO GPIOB
#define PWM_DOUBLE_SERVO_4_PIN GPIO9
#define PWM_DOUBLE_SERVO_4_AF 0
#define PWM_DOUBLE_SERVO_4_OC TIM_OC4
#define PWM_DOUBLE_SERVO_4_OC_BIT (1<<3)
#else
#define PWM_DOUBLE_SERVO_4_OC_BIT 0
#endif
#define PWM_DOUBLE_TIM4_CHAN_MASK (PWM_SERVO_1_OC_BIT|PWM_SERVO_2_OC_BIT|PWM_SERVO_3_OC_BIT|PWM_SERVO_4_OC_BIT)
