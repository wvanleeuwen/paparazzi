...
//TODO: Spektrum to use TIM1 of no PPM in use at same time, then we can have ALL the 8 Servo outputs again
#if USE_PPM_IN_AND_SPEKTRUM_IN_AT_SAME_TIME
#define SPEKTRUM_TIMER 3
else
//TODO: Test it
//#define SPEKTRUM_TIMER 1
#endif
 ...
 * PPM input
 */
//TODO: Only if no need for *and* all servo out *and* a Spektrum RX
 ...
 * PWM
 */
//Servo outputs on PX4IO f1:
//Connector #:   1   2   3   4   5   6   7   8
//PIN:           A0  A1  B8  B9  A6  A7  B0  B1
//Timer/Channel: 2/1 2/2 4/3 4/4 3/1 3/2 3/3 3/4
#define PWM_USE_TIM2 1
//TODO: if PPM *AND* Spektrum RX at same time in use no TIM3 possible, Spektrum RX already uses TIM3
#if USE_PPM_IN_AND_SPEKTRUM_IN_AT_SAME_TIME
//NOP
#else
