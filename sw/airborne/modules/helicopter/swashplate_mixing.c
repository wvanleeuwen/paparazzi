...
static const int32_t roll_coef[SW_NB]   = SW_MIXING_ROLL_COEF;
static const int32_t pitch_coef[SW_NB]  = SW_MIXING_PITCH_COEF;
static const int32_t coll_coef[SW_NB]   = SW_MIXING_COLL_COEF;
...
void swashplate_mixing_run(pprz_t in_cmd[])
{
  ...
  for (i = 0; i < SW_NB; i++) {
    ...
    swashplate_mixing.commands[i] /= SW_MIXING_SCALE;
