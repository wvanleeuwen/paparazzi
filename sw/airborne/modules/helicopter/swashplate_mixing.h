...
/* Scaling used for the different mixings */
#define SW_MIXING_SCALE 256
...
#define SW_RIGHT   1
#define SW_COLL    2
#define SW_MIXING_ROLL_COEF   {    0, -256,  0   }
#define SW_MIXING_PITCH_COEF  {  256,    0,  0   }
#define SW_MIXING_COLL_COEF   {    0,    0,  256 }
...
#define SW_MIXING_COLL_COEF   {  256,  256,  256 }
