...
struct Int32AttitudeGains stabilization_gainsA = {
    {STABILIZATION_ATTITUDE_A_PHI_PGAIN, STABILIZATION_ATTITUDE_A_THETA_PGAIN, STABILIZATION_ATTITUDE_A_PSI_PGAIN },
    {STABILIZATION_ATTITUDE_A_PHI_DGAIN, STABILIZATION_ATTITUDE_A_THETA_DGAIN, STABILIZATION_ATTITUDE_A_PSI_DGAIN },
    {STABILIZATION_ATTITUDE_A_PHI_DDGAIN, STABILIZATION_ATTITUDE_A_THETA_DDGAIN, STABILIZATION_ATTITUDE_A_PSI_DDGAIN },
    {STABILIZATION_ATTITUDE_A_PHI_IGAIN, STABILIZATION_ATTITUDE_A_THETA_IGAIN, STABILIZATION_ATTITUDE_A_PSI_IGAIN },
