...
SECTIONS
{
    .sdram.text     : { camera.o(.sdram.text) edit.o(.sdram.text) httpd.o(.sdram.text) i2c.o(.sdram.text) stm_m25p32.o(.sdram.text) printf.o(.sdram.text) xmodem.o(.sdram.text) gps.o(.sdram.text) sky_segmentation.o(.sdram.text) *(.gnu.warning) } > ram
    .l1code         : { main.o(.text) math.o(.text) malloc.o(.text) string.o(.text) srv.o(.text) uart.o(.text) colors.o(.text) jpeg.o(.text) r8x8dct.o(.text) motionvect.o(.text) uart.o(.text) setjmp.o(.text) neural.o(.text) interface_sky_segmentation.o(.text)} > l1code
    .l1data         :
    {
