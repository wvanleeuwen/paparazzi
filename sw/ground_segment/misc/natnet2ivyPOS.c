...
gboolean timeout_transmit_callback(gpointer data) {
  ...
  for(i = 0; i < MAX_RIGIDBODIES; i++) {
    ...
    IvySendMsg("0 REMOTE_GPS %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", aircrafts[rigidBodies[i].id].ac_id,
      ...
      (int)(1000*rigidBodies[i].x),				//X-position in mm
      (int)(1000*rigidBodies[i].y),
      (int)(1000*rigidBodies[i].z)
      );
